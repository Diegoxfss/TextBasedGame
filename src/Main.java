//This game was designed for kids to learn aritmetic. 
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (!hasBasketball) {
            System.out.println("You couldn't buy a basketball after " + MAX_TRIES + " tries ? common..");
            System.out.println("This is a game over message. It looks like you don't want to play");
            return;
        }
        ...
        System.out.println("You won the game! Congratulations! and the seals are crying. ");
        System.out.println("Maybe you should Share the prize with them.");
        System.out.println("If you really want to learn Aritmetic, play one more time. ctrl + F11 ");
    }
